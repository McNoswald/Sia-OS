...
namespace SiaOS.Util.Hardware
{
    class RH
    {
        ...
        {
            Console.WriteLine("Warning: Sia OS Detected that this is running on Real Hardware or a Unsupported VM. \n Because of this features like the FS and GUI will be disabled.");
            Console.ReadKey();
        }
        public static void RError()
        {
            Console.WriteLine("Sorry but you can't do this on Real Hardware or this VM.");
